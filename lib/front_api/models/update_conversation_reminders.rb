  ...
  class UpdateConversationReminders
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FrontApi::UpdateConversationReminders` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FrontApi::UpdateConversationReminders`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'teammate_id')
        self.teammate_id = attributes[:'teammate_id']
      else
        self.teammate_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @teammate_id.nil?
        invalid_properties.push('invalid value for "teammate_id", teammate_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @teammate_id.nil?
