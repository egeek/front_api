...
module FrontApi
  class ImportMessageMetadata
    ...
    attr_accessor :should_skip_rules
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FrontApi::ImportMessageMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FrontApi::ImportMessageMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'should_skip_rules')
        self.should_skip_rules = attributes[:'should_skip_rules']
      else
        self.should_skip_rules = true
      end
    end
    ...
    def list_invalid_properties
      ...
      if @is_inbound.nil?
        invalid_properties.push('invalid value for "is_inbound", is_inbound cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_inbound.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          should_skip_rules == o.should_skip_rules
    end
    ...
    def hash
      [thread_ref, is_inbound, is_archived, should_skip_rules].hash
    end
