  ...
  class TagResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FrontApi::TagResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FrontApi::TagResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_visible_in_conversation_lists')
        self.is_visible_in_conversation_lists = attributes[:'is_visible_in_conversation_lists']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_visible_in_conversation_lists == o.is_visible_in_conversation_lists &&
    ...
    def hash
      [_links, id, name, description, highlight, is_private, is_visible_in_conversation_lists, created_at, updated_at].hash
    end
