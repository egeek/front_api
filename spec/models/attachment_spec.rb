...
# Unit tests for FrontApi::Attachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FrontApi::Attachment do
  let(:instance) { FrontApi::Attachment.new }

  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FrontApi::Attachment)
    end
  end
