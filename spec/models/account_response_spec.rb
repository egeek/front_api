...
# Unit tests for FrontApi::AccountResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FrontApi::AccountResponse do
  let(:instance) { FrontApi::AccountResponse.new }

  describe 'test an instance of AccountResponse' do
    it 'should create an instance of AccountResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FrontApi::AccountResponse)
    end
  end
